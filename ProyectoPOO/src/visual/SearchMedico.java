...
public class SearchMedico extends JDialog {
	...
	public static void main(String[] args) {
		try {
			SearchMedico dialog = new SearchMedico();
	...
	public SearchMedico() {
		...
		contentPanel.setLayout(null);
		{
			...
			panel.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "Medicos:", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
			...
			comboBoxD.setModel(new DefaultComboBoxModel(new String[] {"<Seleccionar>", "Administracion", "Pediatria", "Cirugia", "Laboratorio"}));
	...
	{
		if(comboBoxD.getSelectedIndex() == 0 || comboBoxE.getSelectedIndex() == 0 || (!rdbtnM.isSelected() && !rdbtnF.isSelected()))
		{
	...
	public void loadMedicos() {
		...
		row = new Object[tableMedicos.getColumnCount()];
			...
			if(rdbtnM.isSelected())
			{
				...
				{
					if(medico.getEspecialidad().equals(comboBoxE.getSelectedItem()) && medico.getDepartamento().equals(comboBoxE.getSelectedItem()) 
